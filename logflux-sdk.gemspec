...
Gem::Specification.new do |spec|
  ...
  spec.homepage = 'https://github.com/logflux-io/logflux-ruby-sdk'
  spec.license = 'MIT'
  spec.required_ruby_version = '>= 2.7.0'

  spec.metadata['homepage_uri'] = spec.homepage
  spec.metadata['source_code_uri'] = 'https://github.com/logflux-io/logflux-ruby-sdk'
  spec.metadata['changelog_uri'] = 'https://github.com/logflux-io/logflux-ruby-sdk/blob/main/CHANGELOG.md'
